...
local prefixPoll = core:CreatePollType("Addon Spam by Prefix");
local playerPoll = core:CreatePollType("Addon Spam by Player");
local channelPoll = core:CreatePollType("Addon Spam by Channel");
...
-- Columns
prefixPoll[1] = { label = "name", align = "LEFT" };
prefixPoll[2] = { label = "count",		color = { 0.5, 0.75, 1 }, offset = 500, fmt = "%d" };
...
-- Columns
playerPoll[1] = { label = "name", align = "LEFT" };
playerPoll[2] = { label = "count",		color = { 0.5, 0.75, 1 }, offset = 500, fmt = "%d" };
...
-- Columns
channelPoll[1] = { label = "name", align = "LEFT" };
channelPoll[2] = { label = "count",		color = { 0.5, 0.75, 1 }, offset = 500, fmt = "%d" };
